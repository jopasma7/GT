...
// @version      1.1
// @description  Ejecuta automáticamente el script en la página
// @author       Tú
...
(async function () {
    ...
    try {
        ...
        const interval = setInterval(() => {
            ...
            if (timeLeft <= 0) {
                console.log("¡El tiempo ha terminado! Verificando recursos antes de acuñar...");
                ...
                if (wood >= requiredWood && stone >= requiredStone && iron >= requiredIron) {
                    console.log("Recursos suficientes. Acuñando monedas...");
                    jQuery('input[type="submit"].btn-default[value="Acuñar"]').click();
                } else {
                    console.log("No hay recursos suficientes. Recargando la página...");
                    location.reload(); // Recargar la página
                }

                // Eliminar el temporizador de la pantalla
